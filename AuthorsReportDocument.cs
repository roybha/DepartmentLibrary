...
namespace DepartmentLibrary.Services
{
    public class AuthorsReportDocument : IDocument
    {
        ...
        public AuthorsReportDocument(List<AuthorReportData> reportData, DateTime startDate, DateTime endDate, ClaimsPrincipal user)
        {
            _reportData = reportData;
            _startDate = startDate;
            _endDate = endDate;
            _email = user?.Identity?.Name ?? "unknown@example.com";
        }
            ...
            container.Row(row =>
            {
                row.RelativeItem().Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text($"Generated on {DateTime.Now:dd/MM/yyyy HH:mm}")
                        .FontSize(12);
                    column.Item().AlignCenter().Text($"Generated by: {_email}")
                        .FontSize(12);
